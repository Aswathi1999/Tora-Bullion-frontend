        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              <span className="text-[12px] font-semibold uppercase tracking-[0.32em] text-[#C9982A]">Silver Bullion · UAE</span>
            </motion.div>
            ...
            >
              Silver Bullion<br />
              <span className="text-[#C9982A]">in the UAE</span>
            </motion.h1>
            ...
            >
              A Complete Guide to Silver Bullion in the UAE.
            </motion.p>
            ...
            >
              <Link href="/shop">
                ...
                >
                  Buy and sell silver bullion with Tora Bullion <span className="text-sm">→</span>
                </motion.button>
              </Link>
            </motion.div>
          </div>
          ...
          <div className="relative h-[420px] sm:h-[540px] lg:h-[680px] select-none">
            ...
            >
              <Image src="/silver_bars.jpg" alt="Silver Bullion in UAE" fill className="object-cover object-center" priority />
              ...
              <p className="absolute bottom-5 left-5 text-[9px] font-medium uppercase tracking-[0.26em] text-white/55">Investment Grade · UAE</p>
            </motion.div>
            ...
            >
              <Image src="/silver_bars.jpg" alt="Silver bullion UAE" fill className="object-cover object-bottom" />
            ...
            >
              ...
              >
                ...
                <p className="mt-1.5 text-[8px] uppercase tracking-[0.24em] text-[#bbb]">Dubai & Abu Dhabi</p>
              </motion.div>
            </motion.div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   ABOUT — Understanding Silver Bullion
═══════════════════════════════════════════════════════════════════════════ */
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-12">
        <div className="mb-12 lg:mb-16">
          ...
          >
            ...
            <span className="text-[12px] font-semibold uppercase tracking-[0.32em] text-[#C9982A]">What is Silver Bullion</span>
          </motion.div>
          <motion.h2
          ...
          >
            Understanding <span className="text-[#C9982A]">Silver Bullion</span>
          </motion.h2>
        </div>
        ...
        <div className="grid lg:grid-cols-[5fr_7fr] gap-10 lg:gap-20">
          ...
          >
            <p className="text-[1.12rem] font-medium text-[#333] leading-[1.92] border-l-[3px] pl-6" style={{ borderColor: gr(0.5) }}>
              Silver bullion is the purest form of silver, typically in the form of bars and coins. They are primarily used as an investment asset. Silver bullion is also used as a collectible and also for industrial purposes. As a good hedge against inflation and other economic uncertainties, they are one of the most traded precious metals in the world.
            </p>
          </motion.div>

          <div>
            {[
              'What makes silver bullions stand apart from other silver jewellery is the purity the silver bullions offer. The jewellery will have other metals to make it flexible for different designs. Also, there is silver that is used for investment purposes and also used as a collectible because of its historical significance and rarity.',
              'If you are looking for a trusted silver bullion dealer in the UAE, Tora Bullion can become a right choice for a premium experience.',
            ].map((p, i) => (
              <motion.p
                key={i}
...
/* ═══════════════════════════════════════════════════════════════════════════
   TYPES — Types of Silver Bullion Available in the UAE
═══════════════════════════════════════════════════════════════════════════ */
const typeItems = [
  { num: '01', title: 'Silver Bars in UAE',                body: 'The silver bars are the common form designed for investment and trading purposes. The silver bars in Dubai could be purchased from the Dubai Gold Souk and other reliable bullion traders. The investors looking for silver bars in Abu Dhabi can get in touch with Tora Bullion for quality products.' },
  { num: '02', title: 'Silver Coins in UAE',               body: 'The silver coins are much more affordable and smaller versions of pure silver that are used for investment, gifting, and collecting. Tora Bullion provides silver coins in Dubai and Abu Dhabi.' },
  { num: '03', title: 'Investment-Grade Silver Products',   body: 'Investment-grade silver products other than bars could also be bought in the UAE. The special collectibles and bullions for special occasions are popular among the investors and people in the UAE.' },
]
    ...
    <section ref={ref} className="relative bg-[#0c0c0c] py-16 lg:py-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-12">
        <div className="mb-12 lg:mb-16">
          ...
          >
            <div className="h-px w-12 bg-[#C9982A]" />
            <span className="text-[12px] font-semibold uppercase tracking-[0.32em] text-[#C9982A]">Types of Silver</span>
          </motion.div>
          <motion.h2
            initial={{ opacity: 0, y: 28, filter: 'blur(8px)' }} animate={inView ? { opacity: 1, y: 0, filter: 'blur(0px)' } : {}}
            transition={{ duration: 0.95, delay: 0.08, ease }}
          ...
          >
            Types of Silver Bullion <span className="text-[#C9982A]">Available in the UAE</span>
          </motion.h2>
          <motion.p
          ...
          >
            There are many types of silver bullion that can be bought in the bullion market in the UAE.
          </motion.p>
        </div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   INVESTORS — Why Silver Bullion Continues to Attract Investors
═══════════════════════════════════════════════════════════════════════════ */
const investorCards = [
  { num: '01', title: 'Accessible Precious Metals Ownership', desc: 'Silver bullions provide easier accessibility for precious metal ownership, as they are less expensive than gold bullions.' },
  { num: '02', title: 'Strong Industrial Demand',              desc: 'As the green initiatives are on the rise, the demand for silver in the industrial sector is also rising, making it popular apart from as an investment metal.' },
  { num: '03', title: 'Physical Asset Ownership',              desc: 'Just like gold, silver is also a tangible asset. Investors can physically hold, own and use the metal without any third-party involvement.' },
  { num: '04', title: 'Portfolio Diversification',             desc: 'You can balance your portfolio with silver bullion, offering a good investment plan for facing the economic uncertainties and inflation.' },
  { num: '05', title: 'Global Market Recognition',             desc: 'The silver bullion is renowned worldwide. So, it can be traded anywhere in the world with proper documentation.' },
  { num: '06', title: 'Long-Term Growth Potential',            desc: 'Silver can give you security for long-term wealth protection, and it has the potential to grow in the future.' },
]
    ...
    <section ref={ref} className="relative bg-[#f5f3ef] py-16 lg:py-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-12">
        <div className="mb-12 lg:mb-16">
          ...
          >
            <div className="h-px w-12 bg-[#C9982A]" />
            <span className="text-[12px] font-semibold uppercase tracking-[0.32em] text-[#C9982A]">Why Investors Choose Silver</span>
          </motion.div>
          <motion.h2
            initial={{ opacity: 0, y: 28, filter: 'blur(8px)' }} animate={inView ? { opacity: 1, y: 0, filter: 'blur(0px)' } : {}}
            transition={{ duration: 0.95, delay: 0.08, ease }}
          ...
          >
            Why Silver Bullion Continues <span className="text-[#C9982A]">to Attract Investors</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.8, delay: 0.18, ease }}
            className="mt-4 text-[1rem] text-[#636363] max-w-[540px] leading-[1.82]"
          >
            Even when the popularity of silver does not exceed that of gold, it attracts a large number of investors for many reasons.
          </motion.p>
        </div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   DEMAND — Silver Bullion and Market Demand
═══════════════════════════════════════════════════════════════════════════ */
const demandItems = [
  { num: '01', title: 'Industrial Manufacturing', body: 'Pure silver is important in industries like automotive, healthcare and so on.' },
  { num: '02', title: 'Renewable Energy',          body: 'Silver is essential in the production of solar panels and clean energy technologies.' },
  { num: '03', title: 'Electronics Industry',      body: 'Consumer electronics, electric vehicles, and other communication systems also need silver for its production.' },
  { num: '04', title: 'Global Investment Demand',  body: 'The position of silver is still valid in the physical precious metals investment market.' },
]
    ...
    <section ref={ref} className="relative bg-white py-16 lg:py-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-12">
        <div className="mb-12 lg:mb-16">
          ...
          >
            <div className="h-px w-12 bg-[#C9982A]" />
            <span className="text-[12px] font-semibold uppercase tracking-[0.32em] text-[#C9982A]">Market Demand</span>
          </motion.div>
          <motion.h2
            initial={{ opacity: 0, y: 28, filter: 'blur(8px)' }} animate={inView ? { opacity: 1, y: 0, filter: 'blur(0px)' } : {}}
            transition={{ duration: 0.95, delay: 0.08, ease }}
            className="text-[clamp(2rem,5vw,3rem)] font-bold text-[#111111] leading-[1.06] tracking-tight"
          >
            Silver Bullion and <span className="text-[#C9982A]">Market Demand</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.8, delay: 0.18, ease }}
            className="mt-4 text-[1rem] text-[#636363] max-w-[540px] leading-[1.82]"
          >
            Silver bullion's market demand is increasing every day. There are many sectors that need the usage of silver for proper functioning.
          </motion.p>
        </div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   WHY BUY — Why Buy Silver Bullion from Tora Bullion?
═══════════════════════════════════════════════════════════════════════════ */
const whyItems = [
  { num: '01', title: 'Certified Silver Bullion',  body: 'We provide certified investment silver bars and coins in the UAE for investment and collection purposes.' },
  { num: '02', title: 'Transparent Pricing',        body: 'Tora Bullion follows the live prices to make sure that you are getting the best deals for your investment.' },
  { num: '03', title: 'Multiple Bullion Options',   body: 'With a wide range of silver coins and bars in the UAE, we offer silver bullion starting from 1 gram to 1 kg.' },
  { num: '04', title: 'Trusted Market Knowledge',   body: 'Our experience in the UAE bullion industry will help you to have updated information about the market trends and investment opportunities.' },
  { num: '05', title: 'Secure Transactions',        body: 'All our transactions are backed with clear and compiled procedures to ensure that you are having the best experience.' },
]
...
function WhyBuySection() {
  ...
  return (
    <section ref={ref} className="relative bg-[#0c0c0c] py-16 lg:py-24 overflow-hidden">
      <div className="pointer-events-none absolute inset-0 opacity-[0.026]" style={{ backgroundImage: 'radial-gradient(circle, #C9982A 1px, transparent 1px)', backgroundSize: '28px 28px' }} />
      <div className="pointer-events-none absolute left-1/2 -translate-x-1/2 top-0 h-[500px] w-[1000px] rounded-full blur-[160px]" style={{ backgroundColor: gr(0.06) }} />
      <span className="pointer-events-none select-none absolute left-[-1rem] top-1/2 -translate-y-1/2 text-[20rem] font-bold leading-none" style={{ color: gr(0.04) }}>05</span>
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-12">
        <div className="mb-12 lg:mb-16">
          ...
          <motion.h2
            ...
            className="text-[clamp(2rem,5vw,3rem)] font-bold text-white leading-[1.06] tracking-tight"
          >
            Why Buy Silver Bullion <span className="text-[#C9982A]">from Tora Bullion?</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.8, delay: 0.18, ease }}
            className="mt-4 text-[1rem] text-[#888] max-w-[560px] leading-[1.82]"
          >
            Tora Bullion is supplying silver bullions in Dubai and Abu Dhabi for the best price and with expert guidance.
          </motion.p>
        </div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   CTA — Explore Certified Silver Bullion in the UAE
═══════════════════════════════════════════════════════════════════════════ */
function CTASection() {
  ...
  return (
    <section ref={ref} className="relative bg-[#faf8f4] py-16 lg:py-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[860px] px-5 sm:px-6 lg:px-12 text-center">
        ...
        >
          Explore Certified Silver Bullion <span className="text-[#C9982A]">in the UAE</span>
        </motion.h2>
        ...
        >
          Partner with Tora Bullion for the best silver bullion buying and selling experience in the UAE. With our personalised guidance and uncompromised commitment to quality, we ensure that we will help you through your silver investment journey in the UAE.
        </motion.p>
        ...
        >
          <Link href="/shop">
            ...
            >
              Explore our silver products <span className="text-sm">→</span>
            </motion.button>
          </Link>
        </motion.div>
      </div>
...
const faqs = [
  {
    ...
    a: 'Yes. Silver bullion could be considered a good investment, as it is currently booming in the industrial sector.',
  },
  {
    q: 'Where can I buy silver bullion in the UAE?',
    a: 'You can buy silver bullion in the UAE from Tora Bullion. We have shops at Dubai Gold Souk and Abu Dhabi.',
  },
  {
    q: 'What is the best silver investment in the UAE?',
    a: 'The best silver investment in the UAE is to purchase investment-grade silver bullions, like pure investment silver coins and bars.',
  },
  {
    q: 'Why invest in physical silver?',
    a: 'Silver is one of the most traded metals in the world, and being a precious metal that is always in demand, physical silver investment is a good opportunity.',
  },
  {
    q: 'How does one invest in silver bullion in the UAE?',
    a: 'You can invest in the silver bullion with the help of a reliable silver bullion provider like Tora Bullion. We will give the right guidance to make sure your silver bullion investment is on the right track.',
  },
]
...
/* ═══════════════════════════════════════════════════════════════════════════
   PAGE ROOT
═══════════════════════════════════════════════════════════════════════════ */
export default function SilverBullionUAEPage() {
  return (
