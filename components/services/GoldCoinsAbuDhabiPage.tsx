        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              <span className="text-[12px] font-semibold uppercase tracking-[0.32em] text-[#C9982A]">Gold Coins · Abu Dhabi</span>
            </motion.div>
            ...
            >
              Gold Coins<br />
              <span className="text-[#C9982A]">Abu Dhabi</span>
            </motion.h1>
            ...
            >
              Accessible Precious Metals Investment with Gold Coins. Buy a certified gold coin.
            </motion.p>
            ...
            >
              <Link href="/shop">
                ...
                >
                  Buy certified gold coins in Abu Dhabi <span className="text-sm">→</span>
                </motion.button>
              </Link>
            </motion.div>
          </div>
          ...
          <div className="relative h-[420px] sm:h-[540px] lg:h-[680px] select-none">
            ...
            >
              <Image src="/gold_coins.jpg" alt="Gold Coins Abu Dhabi" fill className="object-cover object-center" priority />
            ...
            >
              <Image src="/gold_coin/gold_coin.jpg" alt="Gold coins investment Abu Dhabi" fill className="object-cover object-bottom" />
...
/* ═══════════════════════════════════════════════════════════════════════════
   ABOUT — A Flexible Way to Invest in Physical Gold
═══════════════════════════════════════════════════════════════════════════ */
    ...
    <section ref={ref} className="relative bg-white py-16 lg:py-28 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-12">
        <div className="mb-12 lg:mb-16">
          ...
          >
            A Flexible Way to Invest in <span className="text-[#C9982A]">Physical Gold</span>
          </motion.h2>
        </div>
        ...
        <div className="grid lg:grid-cols-[5fr_7fr] gap-10 lg:gap-20">
          ...
          >
            <p className="text-[1.12rem] font-medium text-[#333] leading-[1.92] border-l-[3px] pl-6" style={{ borderColor: gr(0.5) }}>
              Precious metal investment is stable and reliable in the investment sphere, and the gold coins are the favourite of many of the first-time investors. Gold coins starting from as small as 1 gram can be the right choice for beginner investors who are looking for the right opening for their investment journey. Buying gold coins even in small quantities will help you to build up your wealth gradually.
            </p>
          </motion.div>

          <div>
            {[
              'For having a good experience for your gold investment journey, you need the help of trusted bullion partners with experience. Tora Bullion can guide you through the ups and downs of the precious metal market, helping you to make informed decisions and have a clear understanding of different aspects that you should understand before and after buying your gold coins in Abu Dhabi.',
              'Tora Bullion offers both high-quality gold coins and authentic information to secure your future with gold coin investments.',
            ].map((p, i) => (
              <motion.p
                key={i}
...
/* ═══════════════════════════════════════════════════════════════════════════
   COLLECTION — Certified Gold Coins for Modern Investors
═══════════════════════════════════════════════════════════════════════════ */
const collectionItems = [
  { num: '01', title: 'Certified Coins',     body: 'Every product we are offering will be certified to ensure the authenticity of each gold coin you purchase with Tora Bullion.' },
  { num: '02', title: 'Purity',              body: 'There is no compromise for the purity of the gold coins we provide. We ensure that all investment-grade coins are of 24K with 999.9 purity.' },
  { num: '03', title: 'Trust',               body: 'With more than 10 years of active industry experience, Tora Bullion knows the importance of trust and owes it never to break it.' },
  { num: '04', title: 'Accessible Options',  body: 'We ensure that you have access to different options of gold coins in Abu Dhabi, which can align with your investment needs.' },
]
    ...
    <section ref={ref} className="relative bg-[#0c0c0c] py-16 lg:py-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-12">
        <div className="mb-12 lg:mb-16">
          ...
          >
            Certified Gold Coins for <span className="text-[#C9982A]">Modern Investors</span>
          </motion.h2>
          <motion.p
          ...
          >
            Tora Bullion has gold coins in different sizes and weightages to ensure that you as an investor can have the right products. Here are the four pillars with which each of our members works to ensure our clients are getting the best.
          </motion.p>
        </div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   BENEFITS — Benefits of Investing in Gold Coins
═══════════════════════════════════════════════════════════════════════════ */
const benefitsItems = [
  { num: '01', title: 'Affordable Entry Point',            desc: 'While compared to the other investment options, even gold bars, gold coins are available in small denominations, making it easier for investors to start small.' },
  { num: '02', title: 'Easy to Buy and Sell',              desc: 'As certified gold coins are recognised all over the world, the process of buying and selling is not complicated, offering the investors convenient liquidity.' },
  { num: '03', title: 'Suitable for Gradual Wealth Building', desc: 'Investment-grade gold coins can help investors to build their wealth at a slow pace, as they can expand their holdings over time.' },
  { num: '04', title: 'Ideal for Gifting and Investment',  desc: 'The gold coins can be used not just for investment; they can be a good option for gifting your near and dear ones.' },
]
    ...
    <section ref={ref} className="relative bg-[#f5f3ef] py-16 lg:py-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-12">
        <div className="mb-12 lg:mb-16">
          ...
          >
            Benefits of Investing in <span className="text-[#C9982A]">Gold Coins</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.8, delay: 0.18, ease }}
          ...
          >
            Many investors choose to buy gold as their investment choice. If you are considering the same, here are some benefits of investing in gold coins.
          </motion.p>
        </div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   CHOOSING — Choosing Gold Coins Based on Your Goals
═══════════════════════════════════════════════════════════════════════════ */
const choosingItems = [
  { num: '01', title: 'Saving for the Future',        body: 'Gold coins will offer a practical way to build your physical gold holding. Gold coins in different sizes can help you accumulate gold that will be under your budget and plan your long term.' },
  { num: '02', title: 'Investing in Precious Metals', body: 'If you are looking for the assets that can help to diversify your portfolio, certified gold coins can give you the entry to gold ownership, maintaining the purity and quality of your investment.' },
  { num: '03', title: 'Wealth Preservation',          body: 'Gold coins have a known asset that can store wealth for multiple generations. As a tangible asset, gold coins can protect your wealth during an economic crisis.' },
  { num: '04', title: 'Gifting with Lasting Value',   body: 'As gold coins combine investment value and long-lasting significance, they are a popular option for gifting during special occasions and celebrations.' },
]
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-12">
        <div className="mb-12 lg:mb-16">
          ...
          <motion.h2
            ...
            className="text-[clamp(2rem,5vw,3rem)] font-bold text-[#111111] leading-[1.06] tracking-tight"
          >
            Choosing Gold Coins Based on <span className="text-[#C9982A]">Your Goals</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.8, delay: 0.18, ease }}
            className="mt-4 text-[1rem] text-[#636363] max-w-[600px] leading-[1.82]"
          >
            You can buy gold coins for many purposes, and to select the right gold coin that suits your needs, there should be clarity on your goals.
          </motion.p>
        </div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   CTA — Start Building Your Gold Portfolio With Confidence
═══════════════════════════════════════════════════════════════════════════ */
function CTASection() {
  ...
  return (
    <section ref={ref} className="relative bg-[#faf8f4] py-16 lg:py-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[860px] px-5 sm:px-6 lg:px-12 text-center">
        ...
        >
          Start Building Your Gold Portfolio <span className="text-[#C9982A]">With Confidence</span>
        </motion.h2>
        ...
        >
          Buying gold coins from reliable gold bullion traders is as important as investing in the right gold coin. Tora Bullion will help you with the right guidance to move forward with the right investment for your gold coin purchases in Abu Dhabi.
        </motion.p>
        ...
        >
          <Link href="/contact">
            ...
            >
              Speak to an Expert <span className="text-sm">→</span>
            </motion.button>
          </Link>
        </motion.div>
      </div>
...
const faqs = [
  {
    q: 'Are gold coins suitable for beginners?',
    a: 'Yes, gold coins can be considered suitable for beginners, as they are much more affordable than the other options and the sizes are much smaller when compared to gold bar options.',
  },
  {
    q: 'Are gold coins easier to sell than jewellery?',
    a: 'Gold coins are generally considered to be easier to sell than gold jewellery because they have lower making charges and there is no complex process.',
  },
  {
    q: 'Does Tora Bullion provide 1-gram gold coins?',
    a: 'Yes, Tora Bullion does provide gold coins of different ranges, starting from 1-gram gold coins.',
  },
]
...
/* ═══════════════════════════════════════════════════════════════════════════
   PAGE ROOT
═══════════════════════════════════════════════════════════════════════════ */
export default function GoldCoinsAbuDhabiPage() {
  return (
