        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              <span className="text-[12px] font-semibold uppercase tracking-[0.32em] text-[#C9982A]">Sell Gold · Abu Dhabi</span>
            </motion.div>
            ...
            >
              Trusted Gold Buyers in Abu Dhabi with Transparent Prices. Sell your gold bullion with Tora Bullion.
            </motion.p>
            ...
            >
              <Link href="/contact">
                ...
                >
                  Sell your gold bullion today <span className="text-sm">→</span>
                </motion.button>
              </Link>
            </motion.div>
          </div>
          ...
          <div className="relative h-[420px] sm:h-[540px] lg:h-[680px] select-none">
            ...
            >
              <Image src="/gold_bars.jpg" alt="Sell Gold in Abu Dhabi" fill className="object-cover object-center" priority />
              ...
              <p className="absolute bottom-5 left-5 text-[9px] font-medium uppercase tracking-[0.26em] text-white/55">Best Rates · Abu Dhabi</p>
            </motion.div>
            ...
            >
              <Image src="/gold_main.jpg" alt="Sell gold bars Abu Dhabi" fill className="object-cover object-center" />
            ...
            >
              ...
              >
                ...
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-wider text-white">Transparent Pricing</p>
                  <p className="text-[8px] text-white/45 mt-0.5">Trusted · Secure</p>
                </div>
              </motion.div>
            </motion.div>
          </div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   ABOUT — Looking to Sell Your Gold Bars in Abu Dhabi?
═══════════════════════════════════════════════════════════════════════════ */
    ...
    <section ref={ref} className="relative bg-white py-16 lg:py-28 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-12">
        <div className="mb-12 lg:mb-16">
          ...
          >
            Looking to Sell Your Gold Bars <span className="text-[#C9982A]">in Abu Dhabi?</span>
          </motion.h2>
        </div>
        ...
        <div className="grid lg:grid-cols-[5fr_7fr] gap-10 lg:gap-20">
          ...
          >
            <p className="text-[1.12rem] font-medium text-[#333] leading-[1.92] border-l-[3px] pl-6" style={{ borderColor: gr(0.5) }}>
              The places to buy gold in Abu Dhabi are much easier to find than the best place to sell the gold in the UAE. There are many reasons for investors to sell their gold bullion, like personal financial reasons and factors related to the market and economy. For you to get the best value for your gold bullions, you need to partner with the right gold bullion traders.
            </p>
          </motion.div>

          <div>
            {[
              'You need professional assistance to get the best value for your gold bullion, be it coins or bars. Tora Bullion offers a transparent selling of gold in the Abu Dhabi process to ensure that every step is clear and you understand the importance of those steps in gold bullion trading. We ensure that you are getting the best offer for your gold bullion.',
              'With premium gold buyback policies, your gold will be in a trusted hand with Tora Bullion.',
            ].map((p, i) => (
              <motion.p
                key={i}
...
/* ═══════════════════════════════════════════════════════════════════════════
   WHAT GOLD — What Gold Products Can You Sell?
═══════════════════════════════════════════════════════════════════════════ */
const goldTypes = [
  { num: '01', title: 'Sell Gold Bars',    body: 'You can sell investment-grade gold bars with Tora Bullion with any different weights and purities. We accept all certified gold bars after an internal verification to ensure the quality.' },
  { num: '02', title: 'Sell Gold Coins',   body: 'Internationally recognised bullion coins and investment gold coins are accepted at Tora Bullion. There will be a thorough authenticity verification, and the final price will be calculated considering the market value too.' },
  { num: '03', title: 'Sell Gold Bullion', body: 'Tora Bullion can be the right place for you to entrust your physical gold investment in the UAE. We ensure that you have a secure selling experience for your bullion products and certified precious metals.' },
]
    ...
    <section ref={ref} className="relative bg-[#0c0c0c] py-16 lg:py-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-12">
        <div className="mb-12 lg:mb-16">
          ...
          >
            What Gold Products <span className="text-[#C9982A]">Can You Sell?</span>
          </motion.h2>
          <motion.p
          ...
          >
            We accept all investment-grade gold bullions of high purity you have to offer. Any gold forms other than bullions, like jewellery, are not accepted at Tora Bullion.
          </motion.p>
        </div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   PROCESS — Our Gold Buyback Process
═══════════════════════════════════════════════════════════════════════════ */
const processSteps = [
  { num: '01', title: 'Gold Evaluation',            body: 'We will examine your gold bullions and evaluate the physical condition with a visual examination.' },
  { num: '02', title: 'Purity Verification',         body: 'After the primary evaluation, there will be a deeper evaluation for the verification of the actual purity of your gold bullion.' },
  { num: '03', title: 'Weight Assessment',            body: 'The gold bullion and gold bars will be assessed to determine the weight of the products you have produced.' },
  { num: '04', title: 'Market-Based Valuation',       body: 'All the final offers will be calculated after understanding and going through the valuation of the current market trends.' },
  { num: '05', title: 'Secure Transaction Completion', body: 'We will offer the best price with the above evaluation, and once you accept the offer, then we can complete the valuation.' },
]
    ...
    <section ref={ref} className="relative bg-[#f5f3ef] py-16 lg:py-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-12">
        <div className="mb-12 lg:mb-16">
          ...
          >
            Our Gold <span className="text-[#C9982A]">Buyback Process</span>
          </motion.h2>
        </div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   WHY — Why Choose Tora Bullion for Selling Gold in Abu Dhabi?
═══════════════════════════════════════════════════════════════════════════ */
const whyItems = [
  { num: '01', title: 'Fair Market Valuation',              desc: 'The prices we offer for your products will be properly aligned with the international live gold market rates.' },
  { num: '02', title: 'Trusted Gold Buyers',                desc: 'As gold bullion traders with more than 10 years of experience in the UAE landscape, we provide professional and transparent services.' },
  { num: '03', title: 'Expert Precious Metals Assessment',  desc: 'The evaluation of bullion products will be carried out by the experienced professionals to get the best result.' },
  { num: '04', title: 'Secure Transactions',                desc: 'Your gold bullion selling experience will be secure and safe with Tora Bullion. All the steps and procedures will be communicated to you without any hidden charges.' },
  { num: '05', title: 'Personalised Support',               desc: 'Our experts will guide you through your gold investment in the UAE with personalised support. We will back you where you need help and help you to make informed decisions.' },
]
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-12">
        <div className="mb-12 lg:mb-16">
          ...
          <motion.h2
            ...
            className="text-[clamp(2rem,5vw,3rem)] font-bold text-[#111111] leading-[1.06] tracking-tight"
          >
            Why Choose Tora Bullion for <span className="text-[#C9982A]">Selling Gold in Abu Dhabi?</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.8, delay: 0.18, ease }}
          ...
          >
            There are many places in Abu Dhabi to sell gold, but with Tora Bullion you will get exclusive benefits and the best prices.
          </motion.p>
        </div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   CTA — Sell Your Gold with the Right Traders
═══════════════════════════════════════════════════════════════════════════ */
function CTASection() {
  ...
  return (
    <section ref={ref} className="relative bg-[#faf8f4] py-16 lg:py-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[860px] px-5 sm:px-6 lg:px-12 text-center">
        ...
        >
          Sell Your Gold with <span className="text-[#C9982A]">the Right Traders</span>
        </motion.h2>
        ...
        >
          Even though you can sell your gold bullions to any traders in Abu Dhabi, only the professional precious metal dealers can give you the best price for your gold bullions. With Tora Bullion and our professional support, elevate your gold bullion selling experience.
        </motion.p>
        ...
        >
          <Link href="/contact">
            ...
            >
              Contact Our Team for a Gold Valuation <span className="text-sm">→</span>
            </motion.button>
          </Link>
        </motion.div>
      </div>
...
const faqs = [
  {
    q: 'How do I sell gold bars in Abu Dhabi?',
    a: 'You can sell your gold bars to trusted gold bullion dealers in Abu Dhabi with proper certifications and a purchase invoice.',
  },
  {
    q: 'Where can I sell my gold coins for the best price?',
    a: 'Selling your gold coins in Abu Dhabi for the best price is not difficult if you are partnering with reliable gold bullion dealers like Tora Bullion.',
  },
  {
    q: 'Can I sell gold coins for cash in Abu Dhabi?',
    a: 'Yes, you can sell gold coins for cash in Abu Dhabi. Just make sure that the dealer you are choosing is offering cash in return for your gold bullions. Tora Bullion provides cash for your gold coins in Abu Dhabi and Dubai.',
  },
  {
    q: 'Where to sell gold bars in Abu Dhabi?',
    a: 'You can sell your gold bars in Abu Dhabi with Tora Bullion. We will give you the best offers and prices considering market value and live spot prices.',
  },
  {
    q: 'Can I track the live gold price before selling?',
    a: 'Yes. You can track the live price of gold on our website or directly at our shop before you sell your gold.',
  },
]
...
/* ═══════════════════════════════════════════════════════════════════════════
   PAGE ROOT
═══════════════════════════════════════════════════════════════════════════ */
export default function SellGoldAbuDhabiPage() {
  return (
